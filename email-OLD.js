  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; color:#333; line-height:1.5; max-width:600px; padding:10px;">
        ...
        <p>
          When someone shows interest but doesn’t book right away, do they usually get followed up?
        </p>

        <p>
          I work with med spas to automatically turn missed inquiries and past clients into booked appointments without adding admin work.
        </p>

        <p>
          Would it be worth a quick 10-minute chat to see if this makes sense for ${businessName}?
        </p>
...
html: `
  <div style="font-family: Arial, sans-serif; color:#333; line-height:1.5; max-width:600px; padding:10px;">
    ...
    <p>
      Most med spas I talk to already get inquiries — the issue is that many never get followed up consistently.
    </p>

    <p>
      Here’s a quick 30-second example showing where bookings usually slip through:
    </p>

    <p>
      <a href="https://jouvella-automations.netlify.app/.netlify/functions/click?id=${id}" target="_blank">
        Watch 30-second example
      </a>
    </p>

    <p>
      If it’s relevant, happy to walk through how this would work for ${businessName}.
    </p>
